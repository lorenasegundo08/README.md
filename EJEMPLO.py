...
def crearPoblacion():
    """
        Crea una poblacion nueva de individuos para la nueva inicializacion
    """
    return [individual(1,9) for i in range(num)]
  
def calcularFitness(individual):
    """
        Calcula el fitness de un individuo concreto, para su posterior uso
    """
    fitness = 0
...
def selection_and_reproduction(population):
    """
        Conlleva el uso del en que todos los elementos de la poblacion (population) y se queda con los mejores
...
def mutation(population):
    """
        Como la mutacion de los individuos  fue al azar, crea nuevos individuos.
    ...
    return population
    """
        Como punto final se crea una poblacion espectaiva dando solucion.
    """
